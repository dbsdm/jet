...
hi packerStatusSuccess guifg=#ffffff          guibg=#3f3f3f   gui=NONE
hi packerFail          guifg=#ff0000          guibg=#3f3f3f   gui=NONE
hi packerStatusFail    guifg=#ffffff          guibg=#3f3f3f   gui=NONE

hi NvimTreeGitNew      guifg=#ffff00          guibg=NONE      gui=NONE
hi NvimTreeGitDirty    guifg=#ff0000          guibg=NONE      gui=NONE
hi NvimTreeGitStaged   guifg=#00ff00          guibg=NONE      gui=NONE
hi NvimTreeGitRenamed  guifg=#ff00ff          guibg=NONE      gui=NONE
hi NvimTreeGitIgnored  guifg=#444444          guibg=NONE      gui=NONE

hi NvimTreeFileNew     guifg=#ffffff         guibg=NONE      gui=NONE
hi NvimTreeFileDirty   guifg=#ffffff         guibg=NONE      gui=NONE
hi NvimTreeFileStaged  guifg=#ffffff         guibg=NONE      gui=NONE
